...
func TestMain(m *testing.M) {
	goleak.VerifyTestMain(m,
		...
		goleak.IgnoreTopFunction("github.com/thusharprakash/go-libp2p-connmgr.(*BasicConnMgr).background"), // inherited from github.com/ipfs/kubo/core.NewNode
		...
		goleak.IgnoreTopFunction("github.com/thusharprakash/go-libp2p-connmgr.(*decayer).process"),         // inherited from github.com/ipfs/kubo/core.NewNode
	)
}
